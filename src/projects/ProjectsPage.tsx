...
export function ProjectsPage() {
  return (
    <div className="projects-page scrollbar-line h-full overflow-auto px-4 pt-8 pb-10">
      <header className="border-y border-[#6e655c] py-8">
      ...
      <p className="mt-6 mb-0 border-b border-[#6e655c] pb-5 text-center leading-relaxed">
        <p>
      ...
      <div className="mt-6 grid grid-cols-[minmax(0,4fr)_minmax(0,1fr)] gap-x-4 gap-y-6">
        <section className="grid grid-cols-2 gap-x-4 gap-y-6 border-r border-[#6e655c] pr-4">
        ...
        <aside className="sticky top-0 flex flex-col gap-8 self-start">
          <ClockPost />
          <SidePost title="Photography" to="photos" figure={FIGURE_CAMERA}>
            <p>here are some photos I took with a:</p>
            <p>- Cannon DSLR EOS 2000D</p>
            <p>- Sony Cyber-Shot DSC-S650</p>
          </SidePost>
          <CatPost />
        </aside>
      </div>
